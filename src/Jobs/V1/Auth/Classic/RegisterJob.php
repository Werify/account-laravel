...
class RegisterJob extends BaseRequest
{
    ...
    public function __construct(array $data)
    {
        ...
        if (isset($data['password'])) $this->data['password'] = $data['password']; $this->data['password_confirmation'] = $data['password_confirmation'];
        if (isset($data['first_name'])) $this->data['first_name'] = $data['first_name'];
    }
